...
"""
--------------------- IMPORTANTE ---------------------
Se tiene que hacer un fichero con las palabras clave, posteriormente, este debe de guardarse en un archivo / coso para 
que sea utilizado en la búsqueda del usuario.

Vamos, ese fichero es independiente a la búsqueda que hace el usuario."""
...
def main():
    ...
    counter = 0
    #Aqui va la salida de
      
    with open('diccionariojaja.txt', 'w') as convert_file: 
